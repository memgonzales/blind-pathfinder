...
/**
 * Class implementing a window for the <b>selection of the speed at which the agent's moves
 * are displayed</b>
 */
public class ChooseSystemBehavior extends JFrame {
    /* User prompt */
    private JTextArea taPrompt;

    /* Text area and button for the first view */
    private JTextArea taOne;
    private JButton btnOne;

    /* Text area and button for the second view */
    ...
    private void init() {
        ...
        /* The user prompt for choosing the view behavior is formatted and added to the window */
        taPrompt = new JTextArea("Choose system view behavior: ");
        ...
        /* The description and image for the first view are formatted and added to the window */
        taOne = new JTextArea("Press the PROCEED button after every action of the miner to proceed " +
                "to the next action.");
        ...
        pLeft.add(taOne);
        pLeft.add(setImage("assets/step.png"));
        pBox.add(pLeft);
        ...
        /* The description and image for the second view are formatted and added to the window */
        taTwo = new JTextArea("Miner traverses the path automatically with a short delay " +
                "after each action.");
        ...
        pRight.add(taTwo);
        pRight.add(setImage("assets/fast.png"));
        pBox.add(pRight);
        ...
        /* The buttons for the first and second views are added to the window */
        btnOne = new JButton("Step by Step");
        pSouth.add(btnOne);

        btnTwo = new JButton("Fast");
        pSouth.add(btnTwo);
